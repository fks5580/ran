		...
		<div class="site-section">
			<div class="container">
				<div class="row justify-content-center">
					<div class="col-md-5">
						<div class="row">
							<form class="form" onsubmit="return naverModifySubmitter();" action="UpdateMember.do" method="post">
								...
								<div class="col-md-12 form-group mb-3">
									<label for="birth">생년월일</label><br> <label for="birth_year">년</label> <input type="text" name="birth_year" value="${mBean.birth_year}" 
										class="form-control form-control-lg"> <label for="birth_month">월</label> <input type="text" name="birth_month" value="${mBean.birth_month}"
										 class="form-control form-control-lg"> <label for="birth_day">일</label> <input type="text" name="birth_day" value="${mBean.birth_day}"
